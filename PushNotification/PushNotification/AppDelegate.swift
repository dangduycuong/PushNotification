...
//  PushNotification
//
//  Created by Dang Duy Cuong on 10/9/20.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if UserDefaults.standard.string(forKey: "test") != nil {
            ...
            let result = mainSB.instantiateViewController(withIdentifier: "TrungXoSoVC") as? TrungXoSoVC
...
extension AppDelegate : UNUserNotificationCenterDelegate {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        print("Khi nhan duoc thong bao co chay vao day")
        // With swizzling disabled you must let Messaging know about the message, for Analytics
        // Messaging.messaging().appDidReceiveMessage(userInfo)
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        print("An vao thong bao thi chay vao day")
